    ...
    return (
        <div className="grid grid-flow-col justify-start col-span-1 items-center bg-white rounded-[2rem] shadow border border-gray-200 px-4 py-3 gap-4 max-w-xl">
            ...
            <div className="w-16 h-16 rounded-full flex items-center justify-center overflow-hidden">
                <img src={'https://i.pinimg.com/736x/41/f6/43/41f643143963891907660e00af6c0dd2.jpg'} alt="product" className="w-24 h-24 object-cover" />
            </div>
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-sm font-bold">
                    <img src={'https://i.pinimg.com/736x/e7/65/04/e7650458fe434cd647eafb289a569fe2.jpg'} alt="brand" className="w-4 h-4" />
                    {'Nike'}
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-500 font-medium mt-1">Batch {'1'}</span>
                </div>
        ...
        <Navbar />
            <section className="w-full min-h-screen">
                ...
                <div className="relative w-full md:h-[70vh] overflow-hidden">
                    <img src="/output-background.png" alt="" className="absolute z-0 w-full mt-0 md:-mt-80"></img>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 bg-[#F6F7F9]">
                            {products.map((product, idx) => (
                                <div key={idx} className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition">
                                    <img src={product.image} alt={product.name} className="w-full h-80 mb-4 rounded-xl object-cover" />
