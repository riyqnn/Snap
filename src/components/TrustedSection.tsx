...
export default function TrustedSection() {
    return (
        <section className="bg-white-secondary py-12 sm:py-16 md:py-20 lg:py-24 border-y border-black-primary">
            <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold text-[#787878] text-center mb-8 sm:mb-12 md:mb-16 px-4'>
                Trusted by Leading Brands
            </h1>
            <div className='overflow-x-auto scrollbar-hide px-4'>
                <section className='flex justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-6xl mx-auto min-w-max lg:min-w-0 pb-4'>
